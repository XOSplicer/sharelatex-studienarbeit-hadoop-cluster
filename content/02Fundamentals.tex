...
The \emph{German \ac{BDSG}} regulates the general principles in data protection
\autocite{bmjv2009bdsg}

\emph{European \ac{GDPR}} \autocite{eu2016gdpr}
...
TODO conclusion best to use open source non-personal data
