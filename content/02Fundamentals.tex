...
When a \ac{BDA} system is set up, it handles data in diverse forms from many sources. Depending on the kind of data there are different legal restriction to the conditions of collection, storage and porcessing thereof. 
%TODO introduce GDPR and other.

Table \ref{fig-legal-data-kinds}
% TODO describe table
