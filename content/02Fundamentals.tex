...
TODO describe yarn architecture resource manager and nodemanager

To implement the \ac{YARN} infrastructure, Hadoop introcudes two services that can be deployed on the cluste
