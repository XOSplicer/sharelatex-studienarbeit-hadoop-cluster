...
\paragraph{}
he section above mentions the most common and interesting categories of BigData tools compatible with Hadoop. It is important to note that many tools do not fit perfectly into these categories and can often be used for multiple purposes.
The paper by \emph{Jonas Ballsfulland} focuses on the usage of these tools.
...
To apprea tools have been crated, that follow different approaches, while still utilizing \ac{HDFS} and \ac{YARN}.
