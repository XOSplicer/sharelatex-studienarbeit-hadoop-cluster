...
\begin{table}[hbt]
	\begin{tabular}{lll}
	  Characteristic & Traditional \acp{RDBMS} & \acf{BDA} \\
	  \hline
...
\begin{table}[hbt]
	\begin{tabular}{l|l|l|l}
	  & \textbf{Internal} & \textbf{Open Source} &  \textbf{Closed Source} \\
	  \hline
	  \textbf{Personal} &  &  &  \\
	  & & & \\
	  \hline
	  \textbf{Anonymized}  & possibly restricted by law & possibly restricted by law & possibly restricted by law\\
	  & & & \\
	  \hline
	  \textbf{Non-Personal} & unrestricted & unrestricted & restricted by license \\
	  & e.g. \ac{DHBW} server monitoring & e.g. academic datasets & e.g. bought datasets\\
	  \hline
	\end{tabular}
	\caption{Kinds of data and their protective legislations}
