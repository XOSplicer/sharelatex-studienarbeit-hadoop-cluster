...
The \ac{GDPR} Portal summarizes the main  \autocite{trunomi2018gdpr}
...
\begin{itemize}
    ...
    \item \emph{Right to Access}
    \item \emph{Right to be Forgotten}
    \item \emph{Data Portability}, i.e. Dat
