...
\begin{enumerate}
    ...
    \end{enumerate}
    TODO ,  when promted to select nodes use manual registaration: reason dont upload ssh private key for root access (maybe in chpt 4). also configure each service close to default with a common password 
