...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item To select the hosts that should be inncluded in the cluster, the \acp{FQDN} including a domain extension 
        
        TODO enter the fqdns when asked which nodes to use of ALL hosts created before
