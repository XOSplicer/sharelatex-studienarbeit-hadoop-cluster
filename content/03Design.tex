...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item 
        TODO assign master node to all service masters, sec services to secondarys
        \item TODO select all client things to all nodes (datanode, nodemanager etc)
        \item TODO configure all the services to the needs. when in doubt use defualt config. set passwords (maybe common) and resolve possible warnings
        The passwords that have been set for each individual service should be documented.
        \item The installation then is being performed on the cluster.
    \end{enumerate}
