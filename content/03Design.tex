...
\label{sec:design:hdp_ambari_ansible}
 ...
 In this approach a first evaluation to a full cluster installation is performed.
 \emph{Ansible} is used to pragmatically set-up the \acp{VM} that are used in this 

\subsubsection{Ambari}
TODO describe Ambari, eg \autocite[][]{hortonworks2018ambari}
