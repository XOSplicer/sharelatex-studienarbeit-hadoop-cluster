...
TODO describe HDP, Ambari, list version matrix
eg \autocite[][]{hortonworks2018ambari}

The tested version of \ac{HDP} is 2.6.3.0 includes Ambari version 2.6.0 and Hadoop (TODO which Hadoop version).
