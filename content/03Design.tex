...
Tom White recommends the following specification for a cluster, based on the needs to a full \ac{BDA} system in 2014:\\
Each node should run on dedicated, commodity hardware.

\quote{

\begin{itemize}
    \item Processor - Two hex/octo-core 3 GHz CPUs
    \item Memory 64-512 GB ECC RAM
    \item Storage - 12−24 × 1−4 TB SATA disks
