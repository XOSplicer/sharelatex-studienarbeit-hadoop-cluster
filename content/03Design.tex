...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Assing slave nodes and clients to all of the nodes. This includes \emph{DataNodes} and \emph{NodeManager} and the Hadoop client tools.
        \item Configure all the services to the needs for the clsuet
        
        TODO configure all the services to the needs. when in doubt use default configuration. set passwords (maybe common) and resolve possible warnings
