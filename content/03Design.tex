...
When creating a new \ac{VM} most of these parameters must be
...
TODO
what is OpenStack, how does it do clustering, what are possibilities, 
multiple OSs to choose from
can be accessed from dhbw network in the Cloud Computing Competence Center (C4) under controller.c4.dhbw-mannheim.de ???
restriction: not easily accessibly from the internet
