...
\paragraph{Cluster Management Systems}
...
The management system can provide, install, manage and monitor every software component that is needed for the Hadoop cluster.
Usually it also provides an graphical user interface

TODO

Some vendors choose to bundle a management system 
together with an specific version of Hadoop and additional Tools. They offer this \emph{}



TODO explain what an distribution / 
