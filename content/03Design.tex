...
However the given OpenStack environment does not allow the allocation of these amounts of resources. Therefore the maximum sized \acs{VM} should be used, and each be given an equal share of the available storage.
...
TODO: Decision is ambari + ansible
