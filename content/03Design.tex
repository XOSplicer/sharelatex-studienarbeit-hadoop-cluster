...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item TODO configure \texttt{ssh_config}
        \item TODO check SSH connection and note down secondary ethernet port
        \item TODO configure \texttt{iventory.ini}
        \item TODO prepare hosts by running \texttt{run_host_setup.sh}
        \item TODO roll outroll our 
    \end{enumerate}
...
TODO write longer sentences maybe
