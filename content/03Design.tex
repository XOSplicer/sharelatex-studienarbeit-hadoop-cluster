...
\begin{itemize}
    ...
    \item \textbf{Lecturers} -- TODO use for lectures, maybe setup for educational purposes
    \item \textbf{Students} -- TODO use in lectures and projects. maybe setup for ed. purposes
\end{itemize}
