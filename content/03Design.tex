...
\begin{enumerate}
    ...
    TODO \urlinline{https://github.com/XOSplicer/studienarbeit-hadoop-cluster-ansible}, can be reused
    \begin{enumerate}
        \item TODO configure \texttt{ssh\_config}
        \item TODO check SSH connection and note down secondary ethernet port
        \item TODO configure \texttt{inventory.ini}
    ...
    \item \textbf{Test Usage} 
        \begin{enumerate}
            ...
            \item TODO test HDFS
            \item TODO test with teragen and terasort \urlinline{https://hadoop.apache.org/docs/r1.0.4/api/org/apache/hadoop/examples/terasort/TeraGen.html}\urlinline{https://community.hortonworks.com/articles/71173/benchmarking-hadoop-with-teragen-terasort-and-tera.html}\urlinline{https://www.systutorials.com/3235/hadoop-terasort-benchmark/}
        \end{enumerate}
        
    
    TODO
    
    TODO test HDFS in general by storing some data. test map reduce by running teragen / terasort from Hadoop Book (Tom White)
\end{enumerate}
