...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Apply the Ansible playbook to the host by running \texttt{\$ ansible-playbook all.yml}. This configures the host systems in such a way that Ambari Server and Client resp. are installed on them.
    \end{enumerate}
