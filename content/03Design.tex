...
Use cases:
e.g. TODO
Philipps paper focues on those use cases.
Main Focus: Usability for lecture use
Easily and reproducable to deploy

requirements are also covered by the WI paper with extensive results and pomparisons
 > runs on mannhei openstack
 > low or no costs
 > fast deployment
