...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Create internal network and security groups.
        \item Create an appropriate number of maximum resource sized \acp{VM} that are connected to both the internal and external network. 
        \item 
