...
Further test included the execution \emph{teragen} and \emph{terasort},, which generate a variable amount of numbers and sorts them, in this case 5 \ac{GB} of data. 
