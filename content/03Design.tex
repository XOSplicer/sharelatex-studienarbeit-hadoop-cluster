...
This cluster utilizes OpenStack \urlinline{https://www.openstack.org/} to provide resources to its users. 
It enables the compositions of compute elements (\acp{VM}), network elements (sub-nets and routers), 
...
TODO insert how many of each unit(20 cpu, 50 gb ram, 1TB storage)
This resources can be used to allocate instances of \ac{VMs} in pre-defined units 
...
\end{itemize}
\autocite[cf.][p. 40ff]{wi2018managementsystems}
