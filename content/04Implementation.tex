...
\begin{enumerate}
    ...
    \item Make sure the correct \ac{SSH} public keys are stored in the \ac{authorized\_keys} file for the user \emph{ubuntu}. This allows updating the access rights in case more developers need access to the server.
    ...
    \item Configure the secondary network interface to be active and receive 
