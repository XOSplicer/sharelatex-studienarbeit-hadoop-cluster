...
As suggested in the execution plan the \emph{terasort} program implemented by \text{omally2008terasort}, which is included in the Hadoop installtion on each cluster node, is used to check the sanity of the \ac{}
